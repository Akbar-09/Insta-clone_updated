                ...
                <div className="flex-grow-[2] flex-basis-[30px] flex flex-col pt-2 max-md:pt-0">
                                ...
                                {isOwnProfile ? (
                                    <>
                                        ...
                                        <Settings
                                            ...
                                            className="ml-2 cursor-pointer text-text-primary hover:rotate-90 transition-transform duration-300"
                                        />
                                    </>
                                ) : (
                                    <>
                    ...
                    <div className="flex mb-5 text-base max-md:hidden text-text-primary">
                        <span className="mr-10">
                            <span className="font-semibold">{postsCount || 0}</span> posts
                        </span>
                        <span
                            className="mr-10 cursor-pointer hover:opacity-70"
