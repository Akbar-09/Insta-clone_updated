...
require('dotenv').config({ path: './search-service/.env' });

// Default to search_db if not in env, assuming standard naming convention or typically same DB connection if shared in dev
